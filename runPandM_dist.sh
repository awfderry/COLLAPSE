...
python /oak/stanford/groups/rbaltman/alptartici/COLLAPSE/scripts/msp_train.py --checkpoint /oak/stanford/groups/rbaltman/alptartici/COLLAPSE/data/checkpoints/dist_Feb28_alp_v1_nonTiedWeights.pt --batch_size 8 --data_dir=/scratch/users/aderry/atom3d/lmdb/MSP/splits/split-by-sequence-identity-30/data --finetune >/oak/stanford/groups/rbaltman/alptartici/COLLAPSE/MSPdist/03stdout.txt 2>/oak/stanford/groups/rbaltman/alptartici/COLLAPSE/MSPdist/03err.txt
